...
-   문자열은 배열과 비슷한 속성을 가지고 있습니다. [레퍼런스(MDN - Array)](https://developer.mozilla.org/ko/docs/Web/JavaScript/Reference/Global_Objects/Array)를 살펴보면서 문자열과 배열의 공통점이 무엇인지 확인해보겠습니다.
